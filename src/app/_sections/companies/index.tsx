...
export function Companies(props: Companies) {
  return (
    <Section
      container="full"
      className="dark:from-dark-surface-primary dark:via-dark-surface-secondary dark:to-dark-surface-primary relative bg-gradient-to-br py-6 sm:py-8 md:py-10 lg:py-14 xl:py-18"
    >
      {/* Background Pattern */}
      <div className="absolute inset-0 dark:opacity-15 dark:sm:opacity-20">
        <div className="absolute inset-0 dark:bg-[radial-gradient(circle_at_30%_40%,rgba(147,197,253,0.08),transparent_50%)] dark:sm:bg-[radial-gradient(circle_at_40%_50%,rgba(147,197,253,0.1),transparent_50%)] dark:lg:bg-[radial-gradient(circle_at_50%_50%,rgba(147,197,253,0.12),transparent_50%)]" />
        <div className="absolute inset-0 dark:bg-[linear-gradient(45deg,transparent_25%,rgba(147,197,253,0.03)_50%,transparent_75%)] dark:sm:bg-[linear-gradient(45deg,transparent_25%,rgba(147,197,253,0.04)_50%,transparent_75%)] dark:lg:bg-[linear-gradient(45deg,transparent_25%,rgba(147,197,253,0.05)_50%,transparent_75%)]" />
      </div>

      {/* Section Title */}
      {props.subtitle && (
        <div className="relative z-10 mb-4 px-4 text-center sm:mb-5 sm:px-6 md:mb-6 lg:mb-8 lg:px-8">
...
function CompanyLogo({ company }: { company: Companies["companies"][0] }) {
  if (!company.image?.url) {
    return (
      <div className="border-border dark:border-dark-border dark:bg-dark-surface-secondary dark:text-dark-text-tertiary flex h-12 w-24 items-center justify-center rounded-md border text-xs sm:h-14 sm:w-28 sm:rounded-lg sm:text-sm md:h-16 md:w-32 lg:h-20 lg:w-40 xl:h-24 xl:w-48">
