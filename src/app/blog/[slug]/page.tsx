...
import {
  ...
  YoutubeRichTextComponent,
} from "../../_components/rich-text";
...
export default async function BlogPage({ params: _params }: { params: Promise<{ slug: string }> }) {
            ...
            body: {
              json: {
                ...
                blocks: {
                  ...
                  on_YoutubeComponentComponent: youtubeComponentFragment,
                },
                content: 1,
                toc: 1,
              },
  ...
  console.log("Blog post data:", JSON.stringify(blogpost, null, 2));
  console.log("Rich text blocks:", blogpost.body.json.blocks);
        ...
        >
          <RichText
            ...
            components={{
              ...
              YoutubeComponentComponent: YoutubeRichTextComponent,
            }}
          >
